...
echo elgg_view_field([
	...
	'fields' => [
			...
			'name' => 'phone',
			'required' => true,
			'value' => elgg_extract('phone', $vars, $entity->campaigns_phone),
		],
			[
			'#type' => 'text',
			'#label' => elgg_echo('campaigns:checkout:company_name'),
			'name' => 'company_name',
			'value' => elgg_extract('company_name', $vars, $entity->campaigns_company_name),
		],
			[
			'#type' => 'text',
			'#label' => elgg_echo('campaigns:checkout:tax_id'),
			'name' => 'tax_id',
			'value' => elgg_extract('tax_id', $vars, $entity->campaigns_tax_id),
		],
	]
]);
